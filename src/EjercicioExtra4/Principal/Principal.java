...
import EjercicioExtra4.Servicios.NIFServicio;

public class Principal {

    public static void main(String[] args) {

        NIFServicio nifSer = new NIFServicio();

        NIF nif = nifSer.crearNIF();

        System.out.println("El DNI con NIF es:");
        nifSer.mostrarNIF(nif);
